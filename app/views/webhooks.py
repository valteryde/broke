...
import hmac
from ..utils.models import Ticket, Comment, User, TicketUpdateMessage

# Create blueprint
webhooks_bp = Blueprint('webhooks', __name__)

# * GitHub Webhook Handlers * #
TICKET_RESOLVE_PATTERN = re.compile(r'(?:fix|fixes|fixed|close|closes|closed|resolve|resolves|resolved)\s*#?([\w-]+)', re.IGNORECASE)
...
def github_webhook():
    ...
    try:
        ...
        computed_signature = 'sha256=' + hmac.new(github_secret.encode(), payload_body, hashlib.sha256).hexdigest()
