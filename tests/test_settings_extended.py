...
def _(c=auth_client, user=auth_user):
    ...
    response = c.post('/api/settings/profile',
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/preferences',
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/notifications',
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/anonymous',
                      data=json.dumps({
                          'enabled': True,
                          'message': 'Welcome!',
                          'projects': []
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/security/password',
                      data=json.dumps({
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/webhooks/regenerate-secret',
                     json={'type': 'github'},
                     content_type='application/json')
    assert response.status_code in [200, 302]
...
def _(c=auth_client):
    ...
    response = c.post(f'/api/settings/projects/update/{project.id}',
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/danger/delete-account',
...
def _(c=auth_client):
    ...
    response = c.post('/api/settings/team/invite',
...
def _(c=client):
    ...
    response = c.post('/welcome/test-token-12345',
