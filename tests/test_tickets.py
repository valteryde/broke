...
def _(c=auth_client, f=fake, ticket=test_ticket):
    ...
    comment_text = f.text()
    response = c.post(f'/api/tickets/{ticket.id}/comment',
...
def _(c=auth_client, ticket=test_ticket):
    ...
    response = c.put(f'/api/tickets/{ticket.id}/status',
...
def _(c=auth_client, ticket=test_ticket):
    ...
    response = c.put(f'/api/tickets/{ticket.id}/priority',
